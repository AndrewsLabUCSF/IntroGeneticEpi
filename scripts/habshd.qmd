...
SAVE_VISUALIZATIONS_PATH <- "~/Downloads"
```
...
![Table1](~/Downloads/demographics_summary.png)


![Table2](~/Downloads/clinical_table1.png)
![Table3](~/Downloads/clinical_table2.png)
![Table4](~/Downloads/imaging_genetic_table.png)
